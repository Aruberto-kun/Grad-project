...
Public Class CRPayrollTotal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MCPMS.CRPayrollTotal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPayrollTotal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPayrollTotal = New CRPayrollTotal()
        rpt.Site = Me.Site
        Return rpt
    End Function
